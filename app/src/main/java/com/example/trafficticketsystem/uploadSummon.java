...
public class uploadSummon {
    String imageURL, plateNo, typeSummon, Location, Time, Date, summonAmount, summonNo, paymentStatus;

    public uploadSummon() {

    }

    public uploadSummon(String imageURL, String plateNo, String typeSummon, String location, String time, String date, String summonAmount, String summonNo, String paymentStatus) {
